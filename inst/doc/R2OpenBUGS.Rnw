...
at \url{https://www.mrc-bsu.cam.ac.uk/software/bugs-project}.
...
freely available statistical software package implementing that language, see \url{https://www.R-project.org/}.
...
i.e., \url{https://CRAN.R-Project.org} or one of its mirrors.
